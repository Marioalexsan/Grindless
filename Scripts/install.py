...
output_path = '../Grindless/bin/x86/Debug/net472/merged/'
...
if sog_install_path is not None:
    try:
        ...
        pass
    shutil.copyfile(output_path + 'Grindless.exe', sog_install_path + 'Grindless.exe')
    print('Installed Grindless in SoG directory.')
